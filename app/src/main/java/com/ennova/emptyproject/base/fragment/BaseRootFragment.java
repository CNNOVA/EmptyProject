...
public abstract class BaseRootFragment<T extends BasePresenter> extends BaseFragment<T> {
    ...
    protected void initEventAndData() {
        //如果要使用此方法需要有个normal_view的id
//        initNormalView(R.id.normal_view);
    }

    private void initNormalView(int normal_view_id) {
        if (getView() == null) {
            return;
        }
        mNormalView = getView().findViewById(normal_view_id);
        if (mNormalView == null) {
